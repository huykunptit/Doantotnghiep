      ...
      <div class="qf-grid">
          ...
          <Card><template #content><div class="qf-section">
            ...
            <ul v-if="existingAttachments.length > 0" class="qf-attachment-list" style="margin-bottom: 14px;">
              <li v-for="att in existingAttachments" :key="att.id" class="qf-attachment-item">
                ...
                <Button icon="pi pi-times" severity="danger" text rounded aria-label="Xóa file" @click="deleteAttachment(att)" />
              </li>
            </ul>
            ...
            <ul v-if="pendingFiles.length > 0" class="qf-attachment-list">
              <li v-for="(file, index) in pendingFiles" :key="'p'+index" class="qf-attachment-item">
                ...
                <Button icon="pi pi-times" severity="danger" text rounded aria-label="Xóa file chờ" @click="removePendingFile(index)" />
              </li>
            </ul>
          </div></template></Card>
        </div>
        ...
        <aside class="qf-sidebar">
          ...
          <div class="qf-actions">
            <Button label="Cập nhật câu hỏi" icon="pi pi-check" class="qf-save-btn" :loading="saving || uploadingFiles" @click="save" />
