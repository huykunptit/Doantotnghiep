...
:global(.dark) .cd-header,
:global([data-theme="dark"]) .cd-header {
  background: rgba(10, 26, 20, 0.88);
}
:global(.dark) .cd-header.is-scrolled,
:global([data-theme="dark"]) .cd-header.is-scrolled {
...
:global(.dark) .cd-dropdown,
:global([data-theme="dark"]) .cd-dropdown {
  background: #142D1F;
