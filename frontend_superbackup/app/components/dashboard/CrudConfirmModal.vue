...
.confirm-close-btn:hover { background: rgba(17,17,17,0.06); color: var(--text, #1e293b); }

.confirm-modal-content {
  padding: 4px 0 8px;
}
.confirm-modal-content h3 {
  margin: 0 0 8px; font-size: 1.05rem; font-weight: 750;
  color: var(--text, #1e293b); letter-spacing: -0.02em;
}
.confirm-desc {
  margin: 0; font-size: 0.875rem; line-height: 1.6; color: var(--muted, #64748b);
}
...
:global(.dark) .confirm-close-btn:hover,
:global([data-theme="dark"]) .confirm-close-btn:hover { background: rgba(255,255,255,0.08); color: #f1f5f9; }
:global(.dark) .confirm-modal-content h3,
:global([data-theme="dark"]) .confirm-modal-content h3 { color: var(--text, #f1f5f9); }
:global(.dark) .confirm-desc,
:global([data-theme="dark"]) .confirm-desc { color: var(--muted, #94a3b8); }
</style>
