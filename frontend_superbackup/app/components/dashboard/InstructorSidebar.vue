...
/**
 * InstructorSidebar — White sidebar with PanelMenu (matches AdminSidebar)
 */
import { ref, computed, watch, onMounted } from 'vue'
import PanelMenu from 'primevue/panelmenu'
import Badge from 'primevue/badge'
import { useInstructorMenuConfig } from '~/composables/useInstructorMenuConfig'
...
const { menuItems } = useInstructorMenuConfig()
...
function toggleCollapse() {
  ...
  if (import.meta.client) {
    localStorage.setItem('instructor-sidebar-collapsed', isCollapsed.value ? '1' : '0')
  }
}
...
<template>
  ...
  >
    <!-- Logo -->
    <div class="sb-brand">
      <NuxtLink to="/instructor" class="sb-brand-link">
