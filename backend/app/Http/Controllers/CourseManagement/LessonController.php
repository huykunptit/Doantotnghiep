...
class LessonController extends Controller
{
    ...
    public function store(Request $request, Course $course): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'type'       => ['nullable', 'string', 'in:video,audio,file,page,quiz,assignment,forum,survey,zoom,meet,document,virtual_class,scorm,h5p,live,offline'],
    ...
    public function update(Request $request, Course $course, Lesson $lesson): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'description' => ['nullable', 'string'],
            'section_id'  => ['nullable', 'integer', 'exists:sections,id'],
            'type'        => ['sometimes', 'string', 'in:video,audio,file,page,quiz,assignment,forum,survey,zoom,meet,document,virtual_class,scorm,h5p,live,offline'],
            'is_preview'  => ['nullable', 'boolean'],
