<template>
  <InstructorWorkspaceShell
    title="Đợt thi & đánh giá"
    description="Quản lý ngân hàng câu hỏi, đề kiểm tra và kỳ thi độc lập theo từng khóa học."
    :breadcrumb="['Trang chủ', 'Đợt thi & đánh giá']"
  >
    <template #actions>
            ...
            <tr v-for="(course, idx) in filteredCourses" :key="course.id">
              ...
              <td>
                <div class="crud-actions">
                  <NuxtLink :to="`/instructor/courses/${course.id}/question-bank`" class="action-btn is-view">Câu hỏi</NuxtLink>
                  <NuxtLink :to="`/instructor/courses/${course.id}/exams`" class="action-btn is-edit">Kỳ thi</NuxtLink>
                </div>
              </td>
            </tr>
          </tbody>
