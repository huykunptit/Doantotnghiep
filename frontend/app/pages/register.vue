<template>
  <NuxtLayout name="auth">
    <div class="space-y-8">
      <!-- Form Header -->
      <div class="space-y-3">
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tạo tài khoản mới</h1>
        <p class="text-[15px] text-gray-500 font-medium">Bắt đầu hành trình học tập cùng EduPress ngay hôm nay.</p>
      </div>
      ...
      <div class="space-y-6">
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <div class="space-y-1.5">
            <label for="name" class="block text-sm font-bold text-gray-700">Họ và tên</label>
            <div class="relative">
        ...
        <p class="text-center text-[15px] font-medium text-gray-500 pt-2 pb-6">
          Đã có tài khoản? 
          <NuxtLink to="/login" class="font-bold text-primary hover:text-primary-dark underline-offset-4 hover:underline transition-all">Đăng nhập</NuxtLink>
        </p>
      </div>
    </div>
  </NuxtLayout>
