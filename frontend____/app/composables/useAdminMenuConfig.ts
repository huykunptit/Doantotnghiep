...
export const CHILD_PARENT_MAP: Record<string, string> = {
  // Courses
  '/admin/courses/create': '/admin/courses',
  '/admin/manage-courses/create': '/admin/manage-courses',
  // Quiz
  '/admin/quiz/create': '/admin/quiz',
  // Question Bank
  '/admin/question-bank/create': '/admin/question-bank',
  // LnD
  '/admin/lnd/learning-paths/create': '/admin/lnd/learning-paths',
  '/admin/lnd/classes/create': '/admin/lnd/classes',
  '/admin/lnd/course-sections/create': '/admin/lnd/course-sections',
}
